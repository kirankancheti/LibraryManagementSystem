...
<form ACTION="BorrowerManagement" method="post">
  <table align="center">
  <tr>

	<td><h3>FIRST NAME</h3> </td><td><input type="text" name="fname" value=""> </td>
             

</tr>
<tr>
 <td><h3>LAST NAME</h3> </td><td><input type="text" name="lname" value=""> </td>
             
</tr>
<tr>
 <td><h3>ADDRESS</h3> </td><td><input type="text" name="address" value=""> </td>
             
</tr>
<tr>
 <td><h3>PHONE</h3> </td><td><input type="text" name="phone" value=""> </td>
             
</tr>
<tr>

<td><input type="submit" value="Create a Borrower"></td>
